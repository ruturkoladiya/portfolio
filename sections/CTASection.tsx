...
function Field({
  label, id, type = "text", value, onChange, error, placeholder, rows,
}: {
    ...
    >
      ...
      <div aria-hidden="true"
        className="absolute bottom-[-200px] left-1/2 -translate-x-1/2
                   ...
                   bg-[radial-gradient(ellipse_at_center,rgba(108,99,255,0.12)_0%,transparent_70%)]" />
      ...
      <div className="relative max-w-6xl mx-auto fade-in-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 mb-8">
              <InfoRow icon={<MailIcon />} label="Email">
                <a
                  ...
                  className="text-accent-2 hover:underline transition-opacity hover:opacity-80"
                >
            ...
            <div className="flex items-center gap-4 mb-10">
              <a
                ...
                className="flex items-center gap-2 text-sm text-muted
                           hover:text-accent-2 transition-colors duration-200"
              >
                <LinkedInIcon />
                LinkedIn
              </a>
            ...
            {/* Education — subtle placement */}
            <div className="border-t border-[var(--border)] pt-6">
              <p className="text-xs text-muted leading-relaxed">
                🎓 B.E. in Computer Engineering · Charutar Vidya Mandal University · CGPA 8.20 / 10
              </p>
            </div>
          </div>

          {/* Right — form panel */}
          <div className="bg-dark-bg3 border border-[var(--border)] rounded-2xl p-8 sm:p-10">
            ...
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center py-8 gap-5">
                ...
                <button
                  onClick={handleReset}
                  className="mt-2 text-sm text-accent-2 hover:underline transition-opacity hover:opacity-75"
                >
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
                ...
                <button
                  ...
                  className="mt-1 w-full py-3.5 rounded-lg text-sm font-medium
                             ...
                             hover:bg-[#5a52e0] hover:-translate-y-px
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="w-9 h-9 flex-shrink-0 rounded-lg bg-dark-bg3 border border-[var(--border)]
                       flex items-center justify-center text-accent-2">
        {icon}
      </span>
      <div>
